...
public class MainActivity extends AppCompatActivity {
   ...
   private byte arts[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter.addFragment(new SongsFragment(),"Canciones");
        viewPagerAdapter.addFragment(new AlbumsFragment(),"Albumes");
    ...
    private void requestStoragePermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
            new AlertDialog.Builder(this).setTitle("Permiso necesario").setMessage("Necesitas leer canciones bro").setPositiveButton("Esta bien", new DialogInterface.OnClickListener() {
                @Override
    ...
    public void sendOnChannel(String name,String artist,int position) {
        ...
        try {
         ...
         notification = new NotificationCompat.Builder(this, channel_1_ID)
                ...
                .setContentText("Canción")
                .setLargeIcon(artwork)
                .addAction(R.drawable.previous_24dp, "Previo", playbackAction(3))
                .addAction(plaorpa, "Pausa", playbackAction(1))
                .addAction(R.drawable.next_24dp, "Siguiente", playbackAction(2))
