    ...
    public ArrayList<Song> getAllAudioFromDevice() {
        ...
        if (c != null) {
            while (c.moveToNext()) {
                ...
                String path = c.getString(0);   // Recuperar ruta.
                String name = c.getString(1);   // Recuperar nombre.
                String album = c.getString(2);  // Recuperar el nombre del álbum.
                String artist = c.getString(3); // Recuperar el nombre del artista.
